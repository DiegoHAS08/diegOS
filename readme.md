```markdown
# 🚀 diegOS — Operating System From Scratch

O **diegOS** é um sistema operacional de 32 bits (arquitetura x86) construído completamente do zero, direto no metal (*bare-metal*), utilizando **C** e **Assembly x86**, com scripts de automação em **Python**.

Este projeto foi desenhado para explorar os limites mais profundos da computação: como o processador inicializa, gerenciamento de memória real, comunicação direta com o hardware via Portas I/O e desenvolvimento sem nenhuma biblioteca padrão (*freestanding environment*).
